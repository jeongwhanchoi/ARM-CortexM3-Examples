...
//--------------------------------Huins Driver----------------------------------------
/**
  * @brief  Alternative Function Configuration 
  * @param  Port Number,  Pin Number, Alternative Function Number 
  * @retval None
  * @HyunKH
  */
void AF_ConfigPin (uint8_t portNum, uint32_t pinNum, uint8_t alterFunction)
{
	PINSEL_CFG_Type PinCfg;
	
	PinCfg.Portnum = portNum; 
	PinCfg.Pinnum = pinNum;	
	PinCfg.Funcnum = alterFunction; // Alternate function 
